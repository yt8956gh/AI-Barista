...
DATASET_ROOT1 = "/home/pwrai/train_photo_preprocessed_ls/"
PATH_TO_WEIGHTS = './Model_ResNet_Reg-8_square.pth'
RB_PATH_TO_WEIGHTS = './recently_best_Model_ResNet_Reg-8_square.pth'
...
def train(i,train_acc,train_loss):
    ...
    if i==1:
        ...
        my_output_module = nn.Sequential(
                nn.Linear(f(1024)*f(1024)*2048, REG_OUTPUT),
                nn.Softmax(dim=1))
